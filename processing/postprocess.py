...
def line_intersection(line1, line2):
    ...
    # Check if intersection is a point and return its coordinates
    if intersection and isinstance(intersection[0], Point):
...
def detect_lines(image):
    ...
    try:
        ...
        print(f"Error in converting image to grayscale: {e}")
